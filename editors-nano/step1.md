Para abrir un archivo de texto, se utiliza el comando `nano`, seguido del nombre del archivo de texto, si el archivo no existe se va a crear un archivo vacío 
